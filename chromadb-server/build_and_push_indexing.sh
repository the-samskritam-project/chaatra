#!/bin/bash
# Build and push ChromaDB indexing Docker image to Docker Hub
...
IMAGE_NAME="${IMAGE_NAME:-chaatra-chromadb-indexing}"
...
docker buildx build \
  ...
  -f "$SCRIPT_DIR/Dockerfile.indexing" \
...
echo "   ./build_and_push_indexing.sh"
