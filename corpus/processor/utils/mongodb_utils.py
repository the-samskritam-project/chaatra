"""
MongoDB utilities for corpus processing.
...
from processor.utils.item_utils import get_unique_id, get_chapter_from_verse_number, sort_items


def connect_mongodb(connection_string: str, database_name: str) -> Tuple[Database, ClientType]:
    """
...
def write_translated_batch_to_mongodb(
    ...
    Args:
        ...
        collection: MongoDB collection object for raw_translated collection
...
def load_items_from_mongodb(collection) -> List[Dict]:
    ...
    Args:
        collection: MongoDB collection object for raw_transliterated collection
